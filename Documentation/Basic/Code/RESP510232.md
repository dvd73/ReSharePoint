## RESP510232. Inappropriate PublishingWeb.GetPublishingPages() usage.

### Description
There are two methods GetPublishingPages() and GetPublishingPages(uint rowLimit).Both methods lead to the following issues:
