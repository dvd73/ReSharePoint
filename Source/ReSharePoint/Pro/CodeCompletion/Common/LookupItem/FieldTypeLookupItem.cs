...
{
    public class FieldTypeLookupItem : SPLookupItem, IDescriptionProvidingLookupItem
    {
        ...
        public FieldTypeLookupItem(string prefix, string title, string description, DocumentRange replaceRange, CompletionCaseType caseType)
