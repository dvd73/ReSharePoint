...
{
    public class ListUrlLookupItem : SPLookupItem, IDescriptionProvidingLookupItem
    {
        ...
        public ListUrlLookupItem(string prefix, string title, string description, DocumentRange replaceRange, CompletionCaseType caseType)
