...
{
    public class ListTemplateLookupItem : SPIdAndTitleLookupItem, IDescriptionProvidingLookupItem
    {
        ...
        public ListTemplateLookupItem(string prefix, string id, string title, string description, string projectName, byte rank, DocumentRange replaceRange, CompletionCaseType caseType)
