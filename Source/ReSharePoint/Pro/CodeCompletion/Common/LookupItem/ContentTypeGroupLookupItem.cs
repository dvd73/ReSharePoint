...
{
    public class ContentTypeGroupLookupItem : SPLookupItem
    {
        ...
        public ContentTypeGroupLookupItem(string prefix, string title, DocumentRange replaceRange, CompletionCaseType caseType)
