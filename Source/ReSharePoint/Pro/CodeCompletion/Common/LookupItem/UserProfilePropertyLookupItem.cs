...
{
    public class UserProfilePropertyLookupItem : SPLookupItem, IDescriptionProvidingLookupItem
    {
            ...
            ISolution solution, bool keepCaretStill)
        {
            using (new DisableCodeFormatter())
            {
                ...
                {
                    textControl.Document.ReplaceText(ReplaceRange, "PropertyConstants." + Description);
                }
            }
        }
        #endregion
        ...
        public UserProfilePropertyLookupItem(string prefix, string title, string description, DocumentRange replaceRange, CompletionCaseType caseType)
