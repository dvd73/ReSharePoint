...
{
    public class RegistrationTypeLookupItem : SPLookupItem
    {
        ...
        public RegistrationTypeLookupItem(string prefix, string title, DocumentRange replaceRange, CompletionCaseType caseType)
