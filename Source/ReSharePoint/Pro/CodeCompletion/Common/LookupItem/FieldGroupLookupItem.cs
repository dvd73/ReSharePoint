...
{
    public class FieldGroupLookupItem : SPLookupItem
    {
        ...
        public FieldGroupLookupItem(string prefix, string title, DocumentRange replaceRange, CompletionCaseType caseType)
