...
{
    public class WebPartGroupLookupItem : SPLookupItem
    {
        ...
        public WebPartGroupLookupItem(string prefix, string title, DocumentRange replaceRange, CompletionCaseType caseType)
