...
{
    public class RegistrationIdLookupItem : SPIdAndTitleLookupItem
    {
        ...
        public RegistrationIdLookupItem(string prefix, string id, string title, string projectName, byte rank,
            DocumentRange replaceRange, CompletionCaseType caseType)
