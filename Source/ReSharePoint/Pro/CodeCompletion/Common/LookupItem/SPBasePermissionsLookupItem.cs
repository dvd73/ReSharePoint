...
{
    public class SPBasePermissionsLookupItem : SPLookupItem, IDescriptionProvidingLookupItem
    {
        ...
        public SPBasePermissionsLookupItem(string prefix, string title, string description, DocumentRange replaceRange, CompletionCaseType caseType)
