...
namespace ReSharePoint.Pro.CodeCompletion
{
    ...
    public class FieldLookupList : ItemsProviderOfSpecificContext<SPXmlCodeCompletionContext>
    {
        ...
        private bool IsInvalid(ITreeNode treeNode)
        {
            ...
            {
                if (attributeValue.Parent is IXmlAttribute attribute && attribute.AttributeName == "List")
                {
