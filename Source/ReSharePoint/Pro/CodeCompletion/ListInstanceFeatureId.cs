...
namespace ReSharePoint.Pro.CodeCompletion
{
    ...
    public class ListInstanceFeatureId : ItemsProviderOfSpecificContext<SPXmlCodeCompletionContext>
    {
        ...
        private bool IsInvalid(ITreeNode treeNode)
        {
            ...
            {
                if (attributeValue.Parent is IXmlAttribute attribute && attribute.AttributeName == "FeatureId")
                {
        ...
        protected override bool AddLookupItems(SPXmlCodeCompletionContext context, IItemsCollector collector)
        {
            ...
            CommonHelper.FillFeatures(context, collector, prefix, solution, project, CompletionCaseType._ListInstanceFeatureId);
