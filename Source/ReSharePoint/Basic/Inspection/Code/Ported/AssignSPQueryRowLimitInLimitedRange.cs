...
{
    [RegisterConfigurableSeverity(SPC050250Highlighting.CheckId,
        null,
    ...
    public class AssignSPQueryRowLimitInLimitedRange : SPElementProblemAnalyzer<IAssignmentExpression>
    {
        protected override bool IsInvalid(IAssignmentExpression element)
        {
            ...
            if (expressionType.IsResolved &&
                element.Dest.IsResolvedAsPropertyUsage(ClrTypeKeys.SPQuery, new[] { "RowLimit" }) &&
                element.Source != null && element.Source.ConstantValue.IsInteger())
            {
