...
[assembly: RegisterConfigurableSeverity(SPC015301Highlighting.CheckId,
  null,
  Consts.CORRECTNESS_GROUP,
  SPC015301Highlighting.CheckId + ": " + SPC015301Highlighting.Message,
  "Module can only be deployed with Features of scope 'Web' or 'Site'. ",
  Severity.ERROR
  )]
...
namespace ReSharePoint.Basic.Inspection.Xml.Ported
{
    ...
    public class DoNotDefineModuleInFeatureWithWrongScope : SPXmlTagProblemAnalyzer
    {
        protected override bool IsInvalid(IXmlTag element)
        {
            bool result = false;

            if (element.Header.ContainerName == "Module")
            {
        ...
        {
            return new SPC015301Highlighting(element);
        }
    }

    [ConfigurableSeverityHighlighting(CheckId, XmlLanguage.Name, OverlapResolve = OverlapResolveKind.NONE, ShowToolTipInStatusBar = true)]
    public class SPC015301Highlighting : SPXmlErrorHighlighting<IXmlTag>
    {
        public const string CheckId = CheckIDs.Rules.Module.SPC015301;
        public const string Message = "Do not define Module in Feature with scope 'WebApplication' or 'Farm'";

        public SPC015301Highlighting(IXmlTag element) :
