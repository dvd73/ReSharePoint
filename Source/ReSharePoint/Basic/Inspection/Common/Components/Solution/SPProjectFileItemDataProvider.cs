...
{
    public abstract class SPProjectFileItemDataProvider<T> : IProjectFileDataProvider<T> where T : SPProjectFileCacheItem
    {
        ...
        protected SPProjectFileItemDataProvider(Lifetime lifetime, ISolution solution, IProjectFileDataCache cache)
        {
            myCache = cache;
            mySolution = solution;
        ...
        public virtual T GetCacheContent(IProject project)
        {
            return myCache.GetData(this, project, null);
        }
    ...
    [Serializable()]
    public class SPProjectFileCacheItem
    {
